...
<head>
	...
	<title>Lost Password &bull; CI-Strap</title>
			...
			<div class="col-md-4 col-md-offset-4">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 primary-content rounded-bottom">
						...
						<div class="row">
							<div class="col-md-12"><center><h5>You will receive an email with further instructions.</h5></center>
							</div>
						</div>
						<?php echo form_open('login/password', array('class' => 'form-horizontal', 'role' => 'form')); ?>
							<div class="form-group">
								<div class="col-md-12"/><?php if (!empty($errors)) : ?><div class="bg-danger"><center>Oops!  Looks like that email does not exist.</center></div><?php endif; ?></div>
							</div>
							<div class="form-group <?php if (!empty($errors)) : ?>has-error<?php endif; ?>">
								<div class="col-md-12"><input class="form-control"  value="<?php if (isset($email)){echo $email;} ?>" type="text" name="email" placeholder="email@gmail.com" tabindex="1"/></div>
							</div>
							<div class="form-group">
